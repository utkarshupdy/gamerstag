...
const memberData = {
  ...
  subtitle: "Securing the Gaming Revolution with Innovation",
  hashtag: "#CyberSecurityExpert #EthicalHacker #GameTechFounder",
  awards: "Kerala's Pioneering Ethical Hacker, Apple & Google Security Expert, Law Enforcement Collaborator",
  company: "GAMERS TAG",
  location: "Kerala, India",
  image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=center",
  expertise: ["Ethical Hacking", "Cybersecurity Architecture", "Mobile Security (iOS/Android)", "Web Application Security", "Bug Bounty Hunting", "Security Research", "Law Enforcement Collaboration", "Security Community Building"],
  description: "As Chief Security Officer, I bring deep cybersecurity expertise and ethical hacking skills to GAMERS TAG. My mission is to build the most secure gaming platform while driving innovation that transforms how the world views gaming.",
  longDescription: "I represent a remarkable example of young cybersecurity talent in India, having achieved international recognition as an ethical hacker while pursuing mechanical engineering studies. At just 21, I gained widespread attention in 2016 when I successfully bypassed Apple's iPad activation lock, demonstrating exceptional technical skills that caught the attention of major technology companies and law enforcement agencies. My expertise spans from finding critical vulnerabilities in major platforms like Google Cloud Platform to collaborating with Kerala Police's Cyberdome initiative to combat cybercrime and film piracy.",
  achievements: [
    "Successfully bypassed Apple's iPad activation lock, gaining international recognition",
    "Discovered critical vulnerability in Google Cloud Platform earning $7,500 bug bounty and Hall of Fame recognition",
    "Earned $9,500+ in total bug bounties from BlackBerry, Twitter, and other major tech companies",
    "Co-founded 0SecCon, India's first open security community for students",
    "Collaborated with Kerala Police Cyberdome to combat cybercrime and film piracy",
    "Helped reduce Malayalam film piracy to almost nil, protecting films like 'Pulimurugan'",
    "Featured in multiple technology companies' Halls of Fame over four-year period"
  ],
  careerPath: [
    {
      ...
      description: "Leading cybersecurity strategy and building secure gaming infrastructure for millions of users worldwide"
    },
    {
      role: "Cybersecurity Researcher & Ethical Hacker",
      company: "Independent",
      duration: "2016 - Present",
      description: "Conducting security research, discovering vulnerabilities in major platforms, and earning recognition from tech giants"
    },
    {
      role: "Security Consultant",
      company: "Kerala Police Cyberdome",
      duration: "2016 - 2020",
      description: "Collaborated with law enforcement to combat cybercrime, particularly focusing on film piracy prevention"
    },
    {
      role: "Co-Founder",
      company: "0SecCon (Security Community)",
      duration: "2017 - Present",
      description: "Building India's first open security community for students to nurture next generation of ethical hackers"
    }
  ],
  education: [
    {
      degree: "Bachelor of Technology - Mechanical Engineering",
      institution: "Amal Jyothi Engineering College, Kanjirappally",
      year: "Final Year Student (2016 era)"
    }
  ],
  certifications: [
  ...
  contact: {
    email: "hemanth@gamerstag.com",
    linkedin: "https://www.linkedin.com/in/hemanthjoseph",
    website: "https://www.hemanthjoseph.com/"
  },
  workingOn: [
    "Next-generation gaming security protocols",
    "AI-powered threat detection systems for gaming platforms", 
    "Blockchain-based gaming asset protection",
    "Community building for ethical hackers in gaming"
  ],
  mentorshipAreas: [
            ...
            >
              <div className="relative">
                ...
                <div className="relative mb-8 group">
                  <div className="relative w-80 h-80 mx-auto border-2 border-[#E5042F] bg-gradient-to-br from-[#E5042F]/20 to-black overflow-hidden hover:shadow-[0_0_40px_rgba(229,4,47,0.6)] transition-all duration-500"
                       style={{
                         clipPath: 'polygon(0 0, calc(100% - 30px) 0, 100% 30px, 100% 100%, 30px 100%, 0 calc(100% - 30px))'
                       }}>
                    
                    {/* White glassmorphic overlay */}
                    <div className="absolute inset-0 bg-white/3 opacity-0 group-hover:opacity-100 transition-all duration-700 ease-out z-10"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-white/5 to-white/10 opacity-0 group-hover:opacity-90 transition-all duration-700 ease-out z-10"></div>
                    ...
                    {/* Subtle inner glow */}
                    <div className="absolute inset-0 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-10"></div>
                    ...
                    {/* Corner Markers */}
                    <div className="absolute top-2 left-2 w-6 h-6 border-t-2 border-l-2 border-white/60 group-hover:border-white transition-colors duration-300 z-20"></div>
                    <div className="absolute top-2 right-2 w-6 h-6 border-t-2 border-r-2 border-white/60 group-hover:border-white transition-colors duration-300 z-20"></div>
                    <div className="absolute bottom-2 left-2 w-6 h-6 border-b-2 border-l-2 border-white/60 group-hover:border-white transition-colors duration-300 z-20"></div>
                    <div className="absolute bottom-2 right-2 w-6 h-6 border-b-2 border-r-2 border-white/60 group-hover:border-white transition-colors duration-300 z-20"></div>
                    
                    {/* Status Indicator */}
                    <div className="absolute top-4 right-4 z-20">
                      <div className="w-4 h-4 bg-green-400 rounded-full animate-pulse group-hover:bg-white group-hover:shadow-[0_0_8px_rgba(255,255,255,0.8)] transition-all duration-300"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <motion.div 
                    className="group bg-black/80 border border-[#E5042F]/30 p-4 relative overflow-hidden transition-all duration-700 hover:border-[#E5042F] hover:shadow-[0_0_20px_#E5042F70] cursor-pointer"
                    style={{
                      clipPath: 'polygon(0 0, calc(100% - 10px) 0, 100% 10px, 100% 100%, 10px 100%, 0 calc(100% - 10px))',
                      transformStyle: 'preserve-3d'
                    }}
                    whileHover={{ scale: 1.02, y: -3, rotateX: 5 }}
                  >
                    {/* White glassmorphic overlay */}
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500 pointer-events-none">
                      ...
                      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-white/40 to-transparent animate-pulse" style={{animationDelay: '1s'}}></div>
                    </div>
                    
                    <div className="relative z-10">
                      <div className="flex items-center space-x-3 mb-2">
                        <Building className="w-5 h-5 text-[#E5042F] group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)] transition-all duration-500" />
                        <span className="font-medium text-white group-hover:text-white transition-colors duration-500">{memberData.company}</span>
                      </div>
                      <div className="flex items-center space-x-3 mb-2">
                        <MapPin className="w-5 h-5 text-[#E5042F] group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)] transition-all duration-500" />
                        <span className="text-gray-300 group-hover:text-white transition-colors duration-500">{memberData.location}</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Shield className="w-5 h-5 text-[#E5042F] group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)] transition-all duration-500" />
                        <span className="text-gray-300 group-hover:text-white transition-colors duration-500">Security Chief</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  <div className="space-y-3">
                    {memberData.contact.linkedin && (
                      <motion.a
                        ...
                        className="group flex items-center space-x-3 bg-black/60 border border-[#E5042F]/30 p-3 hover:border-[#E5042F] transition-all duration-700 relative overflow-hidden hover:shadow-[0_0_15px_#E5042F50] cursor-pointer"
                        style={{
                          clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))',
                          transformStyle: 'preserve-3d'
                        }}
                        whileHover={{ scale: 1.02, y: -2, rotateX: 3 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        {/* White glassmorphic overlay */}
                        <div className="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-all duration-700 ease-out"></div>
                        ...
                        <Linkedin className="w-5 h-5 text-[#E5042F] relative z-10 group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)] transition-all duration-500" />
                        <span className="text-white relative z-10 group-hover:text-white transition-colors duration-500">LinkedIn Profile</span>
                        <ExternalLink className="w-4 h-4 text-gray-400 ml-auto relative z-10 group-hover:text-white group-hover:drop-shadow-[0_0_4px_rgba(255,255,255,0.4)] transition-all duration-500" />
                      </motion.a>
                    )}
                    ...
                    {memberData.contact.website && (
                      ...
                      >
                        ...
                        <Globe className="w-5 h-5 text-[#E5042F] relative z-10 group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)] transition-all duration-500" />
                        <span className="text-white relative z-10 group-hover:text-white transition-colors duration-500">Personal Website</span>
                        <ExternalLink className="w-4 h-4 text-gray-400 ml-auto relative z-10 group-hover:text-white group-hover:drop-shadow-[0_0_4px_rgba(255,255,255,0.4)] transition-all duration-500" />
                      </motion.a>
                    )}
                  </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              Interested in cybersecurity for gaming platforms or want to learn more about ethical hacking?
            </p>
