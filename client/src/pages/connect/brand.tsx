...
export default function BrandForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Brand partnership application submitted:", formData);
    
    await new Promise(resolve => setTimeout(resolve, 1500));
    
    alert("Thank you for your brand partnership inquiry! Our team will review your proposal and contact you within 3-5 business days.");
    setFormData({
      contactingPersonName: "",
      email: "",
      phone: "",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="font-orbitron font-bold text-4xl md:text-6xl text-white mb-6 leading-tight">
                Brand <span className="text-[#E5042F]">Partnership</span>
              </h1>
              
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Collaborate with GAMERS TAG to amplify your brand in the gaming community. Create impactful partnerships that resonate with gamers worldwide.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="font-bold text-lg text-white">Brand Partnerships</h3>
                </div>
                <p className="text-gray-300 mb-2">contactus@gamerstag.in</p>
                <p className="text-gray-400 text-sm">Brand collaboration opportunities</p>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Tell us about your brand, partnership goals, and how we can collaborate to create value for the gaming community..."
                    required
                  />
                </div>
