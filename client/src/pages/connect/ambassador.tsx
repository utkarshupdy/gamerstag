...
import { ArrowLeft, UserCheck, Mail, Phone, Upload } from "lucide-react";
...
export default function AmbassadorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Campus ambassador application submitted:", formData);
    
    await new Promise(resolve => setTimeout(resolve, 1500));
    
    alert("Thank you for applying to be a Campus Ambassador! Our team will review your application and contact you within 5-7 business days.");
    setFormData({
      name: "",
      email: "",
      collegeName: "",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="font-orbitron font-bold text-4xl md:text-6xl text-white mb-6 leading-tight">
                Campus <span className="text-[#E5042F]">Ambassador</span>
              </h1>
              
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Represent GAMERS TAG in your college and be the bridge between gaming innovation and student communities. Join our ambassador program today.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="font-bold text-lg text-white">Ambassador Program</h3>
                </div>
                <p className="text-gray-300 mb-2">contactus@gamerstag.in</p>
                <p className="text-gray-400 text-sm">Campus ambassador opportunities</p>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Why you wanted to be campus ambassador for Gamers Tag? Tell us about your passion for gaming, leadership experience, and how you plan to represent GAMERS TAG in your college..."
                    required
                  />
                </div>
