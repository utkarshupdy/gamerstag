...
export default function GTJobsEnhanced() {
  const subFeatures = [
    {
      icon: Search,
      title: "Smart Job Search",
      description: "AI-powered job matching based on your gaming skills, experience, and career preferences"
    },
    {
      icon: Bell,
      title: "Real-time Job Alerts",
      description: "Instant notifications for new opportunities matching your profile and interests"
    },
    {
      icon: MessageCircle,
      title: "Direct Messaging",
      description: "Connect directly with hiring managers, team leaders, and industry professionals"
    },
    {
      icon: Target,
      title: "Skill Assessment",
      description: "Validate your gaming skills with certified assessments and showcase your expertise"
    },
    {
      icon: Calendar,
      title: "Interview Scheduler",
      description: "Seamlessly schedule and manage interviews with built-in calendar integration"
    },
    {
      icon: Filter,
      title: "Advanced Filters",
      description: "Filter jobs by salary, location, company size, remote options, and gaming genres"
    },
    {
      icon: Star,
      title: "Company Reviews",
      description: "Read authentic reviews from gaming professionals about companies and work culture"
    },
    {
      icon: Globe,
      title: "Global Opportunities",
      description: "Access to gaming jobs worldwide including remote and international positions"
    }
  ];
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Discover 1000+ gaming and esports jobs from top companies worldwide. The best gaming platform in India and premier esports platform in the world for career opportunities.
              </p>
